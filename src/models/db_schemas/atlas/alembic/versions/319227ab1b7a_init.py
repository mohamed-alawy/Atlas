...
Revision ID: 319227ab1b7a
Revises: 
Create Date: 2026-01-30 02:08:29.012984
...
def upgrade() -> None:
    ...
    op.create_index('ix_chunk_asset_id', 'datachunks', ['chunk_asset_id'], unique=False)
    op.create_index('ix_chunk_project_id', 'datachunks', ['chunk_project_id'], unique=False)
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index('ix_chunk_project_id', table_name='datachunks')
    op.drop_index('ix_chunk_asset_id', table_name='datachunks')
